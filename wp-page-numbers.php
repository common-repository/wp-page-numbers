...
<div class="wrap">
<h2>WP Page Numbers</h2>
	<table style="width: 100%;" border="0">
	
		<tr>
			<td><strong>Default text: </strong>Page</td>
			<td colspan="3">
		...
		<tr>
			<td style="width: 400px;"><strong>Default text: </strong>...</td>
			<td colspan="3">
		...
		<tr>
			<td><strong>Number of pages to show: </strong>10 (0 = unlimited)</td>
			<td colspan="3">
		...
		<tr>
			<td><strong>Stylesheet folder name: </strong>blank for default</td>
			<td colspan="3">
		...
		<tr>
			<td><strong>Show page info</strong></td>
			<td>
...
<h2>Instructions</h2>
	...
	<table>
		...
		<tr>
			<td>You can set all the texts to what ever you like, except the numbers. They will still be numbers.</td>
		</tr>
		...
		<tr>
			<td>This will limit your paging menu. Set a of maximum amount of pages to be displayed at the same time. If the textfield is blank, 10 is set by default. If 0 is set, it will not limit the paging.</td>
		</tr>
		<tr>
			<td><strong>Stylesheet folder name</strong></td>
		</tr>
		<tr>
			<td>If you want to create your own CSS stylesheet, make a copy of the 'default' folder (in the folder wp-page-numbers) and rename it to anything you like. Then you can change your CSS file and activate it by setting the 'Stylesheet folder name'.</td>
		</tr>
	</table>
